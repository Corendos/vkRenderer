...
COMPILE_OPTIONS="-std=c++17 -fno-exceptions -g"
...
./build_shaders.sh &&
echo "Building vk_renderer (Debug)" &&
g++ ../src/main.cpp -o ../bin/Debug/vk_renderer $INCLUDE_DIRECTORY_FLAGS $LIB_DIRECTORY_FLAGS $COMPILE_OPTIONS $LIBS $DEFINES
